/**
 * User routes
 * Defines all API endpoints for user management operations
 */
...
const { validateQuery, validateParams } = require('../validators/ajv-validator');
 ...
 * /api/user/{id}/todos:
 *   get:
 *     summary: Get all todos for a specific user (Admin only)
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/:id/todos', requireAdmin, userController.getUserTodos);
